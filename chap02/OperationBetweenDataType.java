...
public class OperationBetweenDataType {
	...
	public static void main(String[] args) {
		...
		// byte value55 = data1 + data2;	//int 보다 작은 자료형은 연산 결과를 int 타입으로 반환
		int value5 = data1 + data2;		//int 보다 작은 자료형은 연산 결과를 int 타입으로 반환
		...
		// short value99 = data3 + data4;  //아래의 이유로 오류 발생
		int value9 = data3 + data4;		//int 보다 작은 데이터 타입을 연산할 경우 int 로 받아야함
