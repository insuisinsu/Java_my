...
class MyComparableClass implements Comparable<MyComparableClass>{
	...
	@Override
	public int compareTo(MyComparableClass o) {		//오름차순 정렬방식 
...
public class TreeMapMehod_2 {

	public static void main(String[] args) {

		//1. MyClass 를 TreeMap의 Key 로 인풋 할 경우 : 실행시 오류 발생
//		TreeMap<MyClass , String> treeMap1 = new TreeMap();
//		
//		MyClass m1 = new MyClass(2, 5);
//		MyClass m2 = new MyClass(3, 3);
//		
//		treeMap1.put(m1, "첫번째");	//Comparable(), Comparator() 를 구현하지 않았는데, TreeMap의 Key 로 사용했음 -> 실행시 오류
//		treeMap1.put(m2, "두번째");
//		
